...
async def start(client,message):
	...
	**Document Or Video** and enter new filename to rename it__
	...
	reply_markup=InlineKeyboardMarkup(
	 [[ InlineKeyboardButton("Support 🇮🇳" ,url="https://t.me/iPepkornBots") ], 
	[InlineKeyboardButton("Subscribe 🧐", url="https://youtube.com/@InvisibleYTV") ]  ]))
	    return
	if id:
	    if old == True:
	        try:
...
async def send_doc(client,message):
       ...
       if update_channel :
       	try:
       		...
       		reply_to_message_id = message.id,
       		reply_markup = InlineKeyboardMarkup(
       		[ [ InlineKeyboardButton("Support 🇮🇳" ,url=f"https://t.me/TrueDealsMaster") ]   ]))
       		return
       try:
